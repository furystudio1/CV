 ...
 */
public class voice_list extends Activity {
    ...
    private class loadVideo extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            this.pd = new ProgressDialog(voice_list.this);
        ...
        protected Boolean doInBackground(Void... params) {
            return Boolean.valueOf(voice_list.this.getVideoList());
        }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result.booleanValue()) {
                ...
                voice_list.this.adapter = new VideoCursorAdapter(f100w,f99h,voice_list.this, voice_list.this.videoList, voice_list.this.imgLoader,4);
                voice_list.this.VideogridView.setAdapter(voice_list.this.adapter);
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textnot.setText("Video not muted \n Click the + button to sound the video and select the video you want");
        textnot.setTypeface(face);
        tvt.setText("Sounding");
    ...
    private void FindbyId() {
        ...
        btn_plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent n = new Intent(voice_list.this,SelectVideoActivity.class);
                n.putExtra("activ",5);
                startActivity(n);
            }
        });
    ...
    private boolean getVideoList() {
        ...
        String str = "%";
        strArr[0] = "%" + getResources().getString(R.string.folder_name) +"/" + "Sound" + str;
    ...
    public void detailFile(int position){
        ...
        DialogUtils.showDetailDialog(voice_list.act,name,size,uri,Duration);
    }
