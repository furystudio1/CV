...
public abstract class BaseCurveProgressView extends View {
     ...
     * Line color
     */
    protected int mColor = getResources().getColor(R.color.grey_app);

    /**
     * duration of one cycle of animation in milliseconds
     */
    protected long mDuration = 1500;
    ...
    public BaseCurveProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setColor(a.getColor(R.styleable.BaseCurveProgressView_lineColor, getResources().getColor(R.color.grey_app)));
            setDuration(a.getInteger(R.styleable.BaseCurveProgressView_duration, 1500));
