...
import com.fury.cv.multipleimageselect.adapters.CustomAlbumSelectAdapter;
import com.fury.cv.multipleimageselect.helpers.Constants;
import com.fury.cv.multipleimageselect.models.Album;
...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableStringBuilder ss = new SpannableStringBuilder(getResources().getText(R.string.album_view));
