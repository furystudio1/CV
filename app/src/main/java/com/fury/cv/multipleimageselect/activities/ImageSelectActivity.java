package com.fury.cv.multipleimageselect.activities;
...
import com.fury.cv.multipleimageselect.adapters.CustomImageSelectAdapter;
...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Typeface face = Typeface.createFromAsset(getAssets(), "fa_font_1.ttf");
        SpannableStringBuilder ss = new SpannableStringBuilder(getResources().getText(R.string.image_view));
        ss.setSpan(new CustumeTypefaceSpan("",face),0,ss.length(), Spanned.SPAN_EXCLUSIVE_INCLUSIVE);

        final SpannableStringBuilder ss2 = new SpannableStringBuilder(getResources().getText(R.string.selected));
        ss2.setSpan(new CustumeTypefaceSpan("",face),0,ss2.length(), Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                actionMode.setTitle(countSelected + " " + ss2);
    ...
    public class CustumeTypefaceSpan extends TypefaceSpan{

        private final Typeface newType ;


        public CustumeTypefaceSpan(String family,Typeface type) {
            super(family);
            newType = type;
        }
